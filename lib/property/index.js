...
// dependencies
var Property = require('vigour-js/lib/observable')
...
// flexbox arrangement
var ArrangeProperty = new SharedProperty({
  prefix: 'ui-arrange'
}).Constructor
...
// addition for hover property
var OpacityProperty = new SharedProperty({
  prefix: 'ui-opacity'
}).Constructor

// addition for hover property
var AnimationProperty = new SharedProperty({
  prefix: 'ui-animated ui'
}).Constructor
